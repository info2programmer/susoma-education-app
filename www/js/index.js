    ...
    magazine: function () {
        ...
        $.ajax({
            ...
            for(list in rply.magazine)
            {
                ...
                magazine += `<div class="card-footer"><a href="http://susomaias.com/susoma/manage_api/downloadMagazine/${rply.magazine[list].wall_magazine_id}" target="_system" class="link external text-color-green">Download</a></div>`
                magazine += '</div>'
            }
