    ...
    magazine: function () {
        ...
        $.ajax({
            ...
            for(list in rply.magazine)
            {
                ...
                magazine += `<div class="card-footer"><a href="http://susomaias.com/susoma/uploads/wallMagazine/${rply.magazine[list].image}" target="_blank" class="link external">View Now</a></div>`
                magazine += '</div>'
            }
